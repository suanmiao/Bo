...
public class WebViewActivity extends Activity implements IWeiboClientListener {
	...
	private int RESULT_RENREN_OK = 2;
	private int RESULT_SINA_OK = 1;
	...
	public void initData() {
		...
		case 2:
			...
			String authUrl = "https://graph.renren.com/oauth/authorize?client_id="
					+ "83d87ef9fa46455da5c607cd7dfe9f91"
					+ "&redirect_uri=http://graph.renren.com/oauth/login_success.html"
					+ "&scope=read_user_album+read_user_feed+publish_feed+publish_checkin+status_update"
					+ "&response_type=token";
	...
	private class WeiboWebViewClient extends WebViewClient {
		...
		public void saveSinaOauthData(String url) {
			...
			WebViewActivity.this.setResult(RESULT_SINA_OK);
		...
		public void saveRenrenOauthData(String url) {
			...
			WebViewActivity.this.setResult(RESULT_RENREN_OK);
			WebViewActivity.this.finish();
